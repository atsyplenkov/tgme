...
Major thanks to Rich Pauloo for the [{textme}](https://github.com/richpauloo/textme) package and Luca Braglia for the [{telegram}](https://github.com/lbraglia/telegram), which this package relies entirely upon.
